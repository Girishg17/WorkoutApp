...
import com.girish.a7minworkout.databinding.ActivityMainBinding
import com.girish.a7minworkout.databinding.ItemExerciseStatusBinding
...
holder.tvItem.background=ContextCompat.getDrawable(holder.itemView.context,R.drawable.item_circular_thin_color_accent_background)
            ...
            model.getIsCompleted()->{
                holder.tvItem.background=ContextCompat.getDrawable(holder.itemView.context,R.drawable.iten_circular_color_accent_background)
